...
button.addEventListener("click", function() {
	paymentWidget.requestPayment({
		...
		orderName: "허브 자판기 A 10",           // 주문명
		successUrl: "http://192.168.10.24:80//userVendingMachine/vmSpaceCheck",  			// 결제에 성공하면 이동하는 페이지(직접 만들어주세요)
		failUrl: "http://192.168.10.24:80/user_vending_machine/vm_payment_fail",			// 결제에 실패하면 이동하는 페이지(직접 만들어주세요)
		amount: "1000",
